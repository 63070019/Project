...
def sampling_option():
    ...
    normal_button.pack()
    garuntee_button = Button(root, text='Garuntee', font = 'dubai 10 bold', command=sampling_g, bg = 'tomato', fg = 'snow', width=10)
...
def sampling_g():
    ...
    Label(root, text="Garuntee Random", font = 'dubai 10 bold').pack()
    ...
    Label(root, text="Garuntee Option", font = 'dubai 10 bold').pack()
    garuntee_option_t = Entry(root)
    garuntee_option_t.pack()

    Label(root, text="How many roll?", font = 'dubai 10 bold').pack()
    roll_t = Entry(root)
    roll_t.pack()
